...
MOCK_DATA = {
    "users": [
        ...
        {"name": "Eddie", "email": "eddie@example.test",
         ...
         "created_at": dt(2020, 4, 30, 23, 38, 48), "provider": "twitter", "resource_uuid": "hij789"},
        {"name": "Mike", "email": "mike@example.test",
         "profile_pic": "https://gitedumoulinavent.com/wp-content/uploads/pexels-photo-1230302.jpeg",
         "username": "miguel", "created_at": dt(2020, 4, 30, 23, 41, 20), "provider": "facebook",
        ...
        {"name": "Eli", "email": "eli@example.test",
         ...
         "username": "murcitdev", "created_at": dt(2020, 4, 30, 23, 46, 46), "provider": "google",
    ...
    "game_status": [
        {"game_id": 1, "status": "pending", "timestamp": dt(2020, 5, 11, 6, 13), "users": [1, 3, 4]},
        {"game_id": 2, "status": "pending", "timestamp": dt(2020, 5, 13, 6, 11), "users": [1, 4]},
        {"game_id": 3, "status": "pending", "timestamp": dt(2020, 5, 12, 6, 11), "users": [1, 3, 4, 5]},
        {"game_id": 3, "status": "active", "timestamp": dt(2020, 5, 13, 6, 11), "users": [1, 3, 4, 5]},
        {"game_id": 4, "status": "pending", "timestamp": dt(2020, 5, 12, 6, 11), "users": [3, 4, 5]},
        {"game_id": 4, "status": "active", "timestamp": dt(2020, 5, 13, 6, 11), "users": [3, 4, 5]}
    ]
}
